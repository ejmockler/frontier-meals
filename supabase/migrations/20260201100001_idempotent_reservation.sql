-- Make reserve_discount_code idempotent
--
-- When a user clears and re-enters a discount code, they should get their
-- existing reservation back instead of an error. This is better UX.
...
COMMENT ON FUNCTION reserve_discount_code IS
  'Atomically validates and reserves a discount code. IDEMPOTENT: Returns existing valid reservation if one exists for this email+code. Reservation expires in 15 minutes.';
